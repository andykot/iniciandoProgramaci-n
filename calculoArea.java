...
public class calculoArea {
	...
	public static void main(String[] args) {
		...
		Scanner geometria = new Scanner(System.in);
		 System.out.println("¿ escribael numero que acompaña a la  figura quiere calcularle el área");
		 ...
		 default: System.out.println("el cálculo del áre del triangulo o circulo es para version premium, revisa que no hayas marcado valor invalido");
